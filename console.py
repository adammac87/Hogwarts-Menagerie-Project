...
vet6 = Vet("Rubeus", "Hagrid", "Dragons")
vet_repo.save_vet(vet6)
vet7 = Vet("Albus", "Dumbledoew", "Magical Birds")
vet_repo.save_vet(vet7)
...
pet_repo.save_pet(pet1)
pet1 = Pet("Nagini", "Snake", "Female", "01.09.21","Tom", "013252545" , "Crazy Snake", True, vet3)
pet_repo.save_pet(pet1)
pet1 = Pet("Buckbeak", "Gryphon", "Male", "11.06.21","Hagrid", "013182525" , "Remember to bow", True, vet2)
pet_repo.save_pet(pet1)
pet1 = Pet("Fawkes", "Phoenix", "Male", "16.09.21","ALbus", "013251225" , "Ever living Bird", True, vet4)
pet_repo.save_pet(pet1)
pet1 = Pet("Mrs Norris", "Cat", "Female", "11.09.21","Filch", "013258925" , "Mean Cat", True, vet2)
pet_repo.save_pet(pet1)
pet1 = Pet("Norbert", "Dragon", "Male", "015.06.14","Hagrid", "013332525" , "Big ol Dragon", True, vet7)
pet_repo.save_pet(pet1)
pet1 = Pet("Fluffy", "Cerebus", "Male", "01.09.21","Hagrid", "013429525" , "Three headed dog", True, vet4)
pet_repo.save_pet(pet1)
pet1 = Pet("Aragog", "Spider", "Male", "15.04.13","Hagrid", "013295275" , "Horrible ,horrible spider", True, vet5)
pet_repo.save_pet(pet1)
pet1 = Pet("Trevor", "Toad", "Male", "11.02.18","Neville", "014325425" , "Slimey", True, vet6)
pet_repo.save_pet(pet1)
pet1 = Pet("Errol", "Owl", "Male", "14.11.13","Bill", "013225525" , "Tiny Owl", True, vet7)
pet_repo.save_pet(pet1)
